...
const Dropdown: React.FC<DropdownProps> = ({ button = "菜单", items }) => {
  return (
    ...
    >
      ...
      <button
        className="bg-[var(--brand-accent)] text-white border-0 px-3.5 py-[7px] rounded-[16px] cursor-pointer font-semibold text-[15px] transition-[box-shadow,background] hover:bg-[var(--brand-accent-strong)] hover:shadow-[var(--brand-shadow)]"
        aria-expanded="false"
        data-oid="2k_c_27"
      >
        {button}
