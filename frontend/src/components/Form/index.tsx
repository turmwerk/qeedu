    ...
    >
      ...
      {fields.map((f) =>
        (() => {
          ...
          const spanClass =
            f.span === 2 ? "col-span-2" : f.span === 3 ? "col-span-3" : "";
          const itemClassName = fieldClassName
            ? `${itemClass} ${fieldClassName} ${spanClass}`
            : `${itemClass} ${spanClass}`;
          return (
              ...
              {f.render ? (
                ...
                <div className="w-full" data-oid="33fxqj.">
                  <div className="flex items-center gap-3" data-oid="avc0gde">
                    <label
                      className="inline-flex items-center gap-1.5 bg-[#f0f7ff] text-[#0066cc] px-3 py-1.5 rounded-md cursor-pointer text-[13px] font-medium transition hover:bg-[#e0efff]"
                      data-oid="aytdcng"
                    >
                      <span className="text-[14px]" data-oid="w0frygc">
                        📂
                      </span>{" "}
                      点击上传资料
                      <input
                    ...
                    <div className="text-[12px] text-[#999]" data-oid="e7l:cap">
                      {f.placeholder || "支持 PDF, Word"}
                    </div>
                  </div>
                  {values[f.name] && (
                    <div
                    ...
                    >
                      {(Array.isArray(values[f.name])
                        ...
                        <div
                          key={idx}
                          className="text-[13px] text-[#444] bg-[var(--brand-accent-soft)] px-2 py-1.5 rounded-md border border-[rgba(75,42,133,0.04)] flex items-center justify-between gap-2"
                          data-oid="d15lwrv"
                        >
                          <span
                          ...
                          <span className="text-[#999] ml-2" data-oid="4k64hvc">
                            {file.size
                ...
                <div className="flex items-center gap-3" data-oid=":-h39f7">
                  <input
                    ...
                    value={values[f.name]}
                    onChange={(e) =>
                      handleChange(f.name, Number(e.target.value))
                    }
                    data-oid="iv01ert"
                  />

                  <div
                    className="min-w-[48px] text-center text-[#666]"
                    data-oid="h5ovd7e"
                  >
                    {values[f.name]}
                  </div>
          ...
          {submitLoading ? (
            ...
            >
              ...
              <span className="inline-flex gap-1" data-oid="_rdnd_p">
                <span
                  className="form-dot w-[5px] h-[5px] rounded-full bg-white opacity-40"
                  data-oid="_zi..3i"
                />

                <span
                  className="form-dot delay-1 w-[5px] h-[5px] rounded-full bg-white opacity-40"
                  data-oid=".1j9-_-"
                />

                <span
                  className="form-dot delay-2 w-[5px] h-[5px] rounded-full bg-white opacity-40"
                  data-oid="9jq51lp"
                />
              </span>
            </span>
