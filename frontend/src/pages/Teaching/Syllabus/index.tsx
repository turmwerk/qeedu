...
| **课程层次** | -- | **理论/实践** | 理论+实验课程 |
| **考试类型** | 闭卷 | **课程�?* | 90111205 |
| **课程�?* | 机器学习导论 | **英文课程�?* | Introduction to machine learning |
| **大纲填写人姓�?* | -- | **课程类别** | 学科基础课程 |
| **课程状�?* | 运行�?| **课程负责人姓�?* | 李文�?|
| **跨学期课�?* | �?| | |
...
3. 进行自我追求教育，引导和培养学生坚韧性格、追求真理、勇攀高峰的精神，辩证看待和研究科学问题�?/td>
  ...
  <tr>
    ...
    <td colspan="3">培养学生卓越的专业素�?培育学生强烈的家国情怀与社会责任感,培养学生探究精神与创新创造能�?提升学生全球素养</td>
  </tr>
  <tr>
...
11. 小样本学习、持续学习、自监督学习：介绍前言热点研究方向，开拓视野�?/td>
  ...
  <tr>
    ...
    <td colspan="3">1、《机器学习�?周志�?清华大学出版�?2016.01 使用非马工程教材</td>
  </tr>
  <tr>
    <td><strong>参考资�?/strong></td>
    <td colspan="3">《机器学习》，周志华著，清华大学出版社
《统计机器学习方法》，李航著，清华大学出版�?
《Machine Learning: An Algorithmic Perspective》，Stephen Marsland (�?</td>
  </tr>
  <tr>
