          ...
          actions={[
            {
              label: (
                <>
                  <FormOutlined /> <span className="hidden sm:inline">继续编辑</span>
                </>
              ),
            ...
            },
            {
              label: (
                <>
                  <EditOutlined /> <span className="hidden sm:inline">重命名</span>
                </>
              ),
              isRename: true,
            ...
            },
            {
              label: (
                <>
                  <DeleteOutlined /> <span className="hidden sm:inline">删除</span>
                </>
              ),
              onClick: (item) => {
