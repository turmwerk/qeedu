...
const HeroSection: React.FC<Props> = ({ headline, description, metrics }) => (
  <section className="rounded-[34px] border border-sky-100 bg-[radial-gradient(circle_at_top_left,#ffffff_0%,#dbeafe_32%,#e0f2fe_62%,#ede9fe_100%)] px-5 py-4 shadow-[0_24px_60px_rgba(96,165,250,0.18)] md:px-6 md:py-5">
