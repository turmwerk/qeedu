...
const HeroSection: React.FC<Props> = ({ headline, description, metrics }) => (
  <section className="rounded-[34px] border border-blue-100 bg-[radial-gradient(circle_at_top_left,#ffffff_0%,#dbeafe_30%,#e0f2fe_60%,#ede9fe_100%)] px-5 py-4 shadow-[0_24px_60px_rgba(59,130,246,0.16)] md:px-6 md:py-5">
