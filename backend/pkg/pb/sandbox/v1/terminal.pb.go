...
const file_sandbox_v1_terminal_proto_rawDesc = "" +
	...
	"\x12InteractiveSession\x12\x19.sandbox.v1.TerminalInput\x1a\x1a.sandbox.v1.TerminalOutput(\x010\x01BKZIgithub.com/dieWehmut/nju-edu-ai-system/backend/pkg/pb/sandbox/v1;sandboxv1b\x06proto3"
