...
func (c *userServiceClient) FindOrCreateOAuthUser(ctx context.Context, in *FindOrCreateOAuthUserRequest, opts ...grpc.CallOption) (*FindOrCreateOAuthUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user.v1.UserService/FindOrCreateOAuthUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetUserByEmail(ctx context.Context, in *GetUserByEmailRequest, opts ...grpc.CallOption) (*GetUserByEmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user.v1.UserService/GetUserByEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_FindOrCreateOAuthUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.v1.UserService/FindOrCreateOAuthUser",
	}
...
func _UserService_GetUserByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.v1.UserService/GetUserByEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
