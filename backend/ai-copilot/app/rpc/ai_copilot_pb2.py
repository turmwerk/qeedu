...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_COMPLETERESPONSE']._serialized_end=266
  _globals['_AICOPILOTSERVICE']._serialized_start=268
  _globals['_AICOPILOTSERVICE']._serialized_end=363
