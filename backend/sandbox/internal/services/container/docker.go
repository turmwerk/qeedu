...
func runtimeImageSubdir(image string) (string, bool) {
	subdirs := map[string]string{
		"edu-ai-sandbox-python:latest":         "python",
		"edu-ai-sandbox-javascript:latest":     "javascript",
		"edu-ai-sandbox-typescript:latest":     "typescript",
		"edu-ai-sandbox-go:latest":             "go",
		"edu-ai-sandbox-java:latest":           "java",
		"edu-ai-sandbox-c:latest":              "c",
		"edu-ai-sandbox-cpp:latest":            "cpp",
		"edu-ai-sandbox-rust:latest":           "rust",
		"edu-ai-sandbox-csharp:latest":         "csharp",
		"edu-ai-sandbox-terminal-bash:latest":  "terminal-bash",
		"edu-ai-sandbox-lsp-go:latest":         filepath.Join("lsp", "go"),
		"edu-ai-sandbox-lsp-python:latest":     filepath.Join("lsp", "python"),
		"edu-ai-sandbox-lsp-typescript:latest": filepath.Join("lsp", "typescript"),
		"edu-ai-sandbox-lsp-java:latest":       filepath.Join("lsp", "java"),
		"edu-ai-sandbox-lsp-cpp:latest":        filepath.Join("lsp", "cpp"),
		"edu-ai-sandbox-lsp-rust:latest":       filepath.Join("lsp", "rust"),
		"edu-ai-sandbox-lsp-csharp:latest":     filepath.Join("lsp", "csharp"),
	}
