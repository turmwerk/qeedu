...
func runtimeImageSubdir(image string) (string, bool) {
	subdirs := map[string]string{
		"qeedu-sandbox-python:latest":         "python",
		"qeedu-sandbox-javascript:latest":     "javascript",
		"qeedu-sandbox-typescript:latest":     "typescript",
		"qeedu-sandbox-go:latest":             "go",
		"qeedu-sandbox-java:latest":           "java",
		"qeedu-sandbox-c:latest":              "c",
		"qeedu-sandbox-cpp:latest":            "cpp",
		"qeedu-sandbox-rust:latest":           "rust",
		"qeedu-sandbox-csharp:latest":         "csharp",
		"qeedu-sandbox-terminal-bash:latest":  "terminal-bash",
		"qeedu-sandbox-lsp-go:latest":         filepath.Join("lsp", "go"),
		"qeedu-sandbox-lsp-python:latest":     filepath.Join("lsp", "python"),
		"qeedu-sandbox-lsp-typescript:latest": filepath.Join("lsp", "typescript"),
		"qeedu-sandbox-lsp-java:latest":       filepath.Join("lsp", "java"),
		"qeedu-sandbox-lsp-cpp:latest":        filepath.Join("lsp", "cpp"),
		"qeedu-sandbox-lsp-rust:latest":       filepath.Join("lsp", "rust"),
		"qeedu-sandbox-lsp-csharp:latest":     filepath.Join("lsp", "csharp"),
	}
